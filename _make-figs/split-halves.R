...
# test = tapply(stroop$rt, list(stroop$S, stroop$trial, stroop$cond), function(x) x)
# 
# score_1 = apply(test, c(1,3), myMean)
# cor(score_1)
# test2 = test
# 
# for (i in 1:dim(score_1)[1]){
#   test2[i,,1] = test[i,,1] - score_1[i,1]
#   test2[i,,2] = test[i,,1] - score_1[i,2]
# }
# score_2 = apply(test2, c(1,3), myMean)
# cor(score_2)
# cor(score_1)
# 
# 
